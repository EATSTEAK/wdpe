...
/// [`ComboBox`](crate::element::selection::ComboBox)의 선택지를 선택하도록 하는 이벤트를 반환
...
/// [`ComboBox`](crate::element::selection::ComboBox)의 내용을 바꾸는 이벤트를 반환
#[allow(unused)]
...
/// [`ComboBox`](crate::element::selection::ComboBox)의 선택지를 `value1`의 값을 기반으로 선택하도록 하는 이벤트를 반환
#[allow(unused)]
...
/// [`ComboBox`](crate::element::selection::ComboBox)의 참조 [`ListBoxDefWrapper`]를 반환
...
/// [`ComboBox`](crate::element::selection::ComboBox)의 값을 반환
...
/// [`ListBox`](crate::element::selection::list_box::ListBox)의 아이템 정보를 가져옴

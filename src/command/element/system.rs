...
/// [`ClientInspector`](crate::element::system::ClientInspector)를 통해 서버에 클라이언트 정보를 전파하는 이벤트를 반환
...
/// [`LoadingPlaceholder`](crate::element::system::LoadingPlaceholder)를 로드하는 이벤트를 반환

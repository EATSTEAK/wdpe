...
/// [`ListBox`](crate::element::selection::list_box::ListBox)의 아이템을 위한 Wrapper
#[derive(Debug)]
#[allow(clippy::large_enum_variant)]
pub enum ListBoxItemWrapper<'a> {
    /// [`ListBox`](crate::element::selection::list_box::ListBox)의 일반 아이템
    Item(ListBoxItem<'a>),
    /// 수행할 수 있는 액션이 포함된 [`ListBox`](crate::element::selection::list_box::ListBox) 아이템
    ActionItem(ListBoxActionItem<'a>),
}

/// [`ListBox`](crate::element::selection::list_box::ListBox)의 아이템의 정의 Wrapper
#[derive(Clone, Debug)]
